   ...
   begin
      case Message.MessageType is
         ...
         when ChangeSettingsRequest => 
            ...
            Put(", CTachyBound: ");
            Put(Message.CTachyBound'Image);
            Put(", CJoulesToDeliver: ");
            Put(Message.CJoulesToDeliver'Image);
            Put(")"); New_Line;
         ...
         when ReadSettingsResponse => 
            ...
            Put(", RTachyBound: ");
            Put(Message.RTachyBound'Image);
            Put(", RJoulesToDeliver: ");
            Put(Message.RJoulesToDeliver'Image);
            Put(")"); New_Line;
         when others =>
            -- you should implement these for your own debugging if you wish
            Put("!!!!!!!!!!!!!!");
            Put(Message.MessageType'Image);
            null;
      end case;
